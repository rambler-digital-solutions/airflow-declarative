...
htmlhelp_basename = 'airflow-declarativedoc'
...
man_pages = [
    (master_doc, 'airflow-declarative', 'airflow-declarative Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'airflow-declarative', 'airflow-declarative Documentation',
     author, 'airflow-declarative', 'One line description of project.',
     'Miscellaneous'),
]
